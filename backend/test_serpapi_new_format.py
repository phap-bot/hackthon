...
async def test_serpapi_new_format():
    """Test SerpAPI with new format"""
    print("Testing SerpAPI with New Format")
    print("=" * 50)
    ...
    # Test coffee shops search with new format
    print("\n1. Testing coffee shops search with new format...")
    try:
    ...
    # Test direct SerpAPI call
    print("\n2. Testing direct SerpAPI call...")
    try:
...
if __name__ == "__main__":
    asyncio.run(test_serpapi_new_format())
